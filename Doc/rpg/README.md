...
| 我要理解 StateComponent 是什么 / 怎么用 | [`05-state-component.md`](05-state-component.md) |
| 我要设计 buff / 持续效果 / 特殊状态(倒地 / 死亡 / 鬼魂)| [`06-buff-system.md`](06-buff-system.md) |
| 我要做召唤兽 / 宠物系统 | [`07-pet-and-formation.md`](07-pet-and-formation.md) |
| 我要做阵法 / 站位系统 | [`07-pet-and-formation.md`](07-pet-and-formation.md) |
| 我要做愤怒 / 特技 / 药品系统 | [`08-anger-and-items.md`](08-anger-and-items.md) |
| 我要处理倒地 / 死亡 / 掉线 / 超时 等边界 | [`09-rules-and-edge-cases.md`](09-rules-and-edge-cases.md) |
...
| [`05-state-component.md`](05-state-component.md) | **StateComponent = 玩法底层"集合"基础设施**(不等于 buff;只关心"我当下有什么 stateId")|
| [`06-buff-system.md`](06-buff-system.md) | **buff 系统 = 典型 Provider 完整实现**(buff 是 Provider 的一种,持有 duration / tick / dispellable)|
| [`07-pet-and-formation.md`](07-pet-and-formation.md) | 召唤兽(资质 / 成长 / 技能 / 内丹)+ 阵法(站位 + 相克)|
| [`08-anger-and-items.md`](08-anger-and-items.md) | 愤怒 / 特技 / 药品系统的设计意图 |
| [`09-rules-and-edge-cases.md`](09-rules-and-edge-cases.md) | 通用规则 + 边界情况(倒地 / 死亡 / 鬼魂 / 掉线 / 超时 / 回合上限)|
...
### 原则 2:**Provider 模式优于手工状态**

`StateComponent`(底层"集合机制")+ **Provider**(业务对象,典型 = buff)协作;**多个 Provider 施加同一 stateId → 全部 Remove 才真正退出**。比手写 `Dictionary<int, int>` 少 80% 边界 case。详见 [`05-state-component.md`](05-state-component.md) 和 [`06-buff-system.md`](06-buff-system.md)。
...
### 原则 5:**Provider(典型 = buff)优于"分类型组件"**

所有"在 / 不在"语义用 `StateComponent` + `stateId`;持续时间 / 效果 / 驱散都交给 **Provider**(典型 = buff)。不要为每种 buff 写一个 bool 字段。详见 [`05-state-component.md`](05-state-component.md) 和 [`06-buff-system.md`](06-buff-system.md)。
...
| 中毒 / 封印 / 隐身 等持续效果 | `StateComponent`(底层"集合机制) + **Provider**(典型 = `Buff`)| [`05-state-component.md`](05-state-component.md) + [`06-buff-system.md`](06-buff-system.md)|
| 倒地 / 死亡 / 鬼魂 | Provider(典型 = `DeathFlag` / `DownFlag` / `GhostFlag`)| [`06-buff-system.md`](06-buff-system.md) §6 |
