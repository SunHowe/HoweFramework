...
项目知识。Agent 流程在 [`../AGENTS/README.md`](../AGENTS/README.md)。写完文档后按 [`../AGENTS/workflow/index-maintenance.md`](../AGENTS/workflow/index-maintenance.md) 更新本文件及子目录 README。

`Client/Assets/**/Doc` 不是知识正文。

## 本目录用途

用源码能核对的事实说明仓库怎么分层、模块怎么用、Gameplay 怎么扩展。

## 先读哪篇

| 我要做什么 | 先读 |
|------------|------|
| 第一次进仓库 | [`architecture/overview.md`](architecture/overview.md)、[`architecture/startup.md`](architecture/startup.md) |
| 用或改某个框架模块 | [`framework/modules/README.md`](framework/modules/README.md) |
...
| 目录 | 用途 |
|------|------|
| [`architecture/`](architecture/README.md) | 仓库分层与启动链 |
