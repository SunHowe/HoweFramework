...
public partial class TbActionConfig : IDataTable
{
    ...
    public TbActionConfig(GameDataManager manager, string dataTableName, LoadDataTableFunc loadDataTableFunc, LoadDataTableAsyncFunc loadDataTableAsyncFunc)
    {
        Instance = this;
        m_Manager = manager;
    ...
    public void Load(bool autoResolveRef = true)
    {
        ...
        {
            throw new Exception("DataTable TbActionConfig is loading");
            return;
        }
        ...
        {
            LoadStatus = DataTableLoadStatus.None;
            throw new Exception("DataTable TbActionConfig load failed");
            return;
        }
