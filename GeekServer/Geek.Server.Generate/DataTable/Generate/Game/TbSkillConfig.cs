...
public partial class TbSkillConfig : IDataTable
{
    ...
    public TbSkillConfig(GameDataManager manager, string dataTableName, LoadDataTableFunc loadDataTableFunc, LoadDataTableAsyncFunc loadDataTableAsyncFunc)
    {
        Instance = this;
        m_Manager = manager;
    ...
    public void Load(bool autoResolveRef = true)
    {
        ...
        {
            throw new Exception("DataTable TbSkillConfig is loading");
            return;
        }
        ...
        {
            LoadStatus = DataTableLoadStatus.None;
            throw new Exception("DataTable TbSkillConfig load failed");
            return;
        }
