...
{
    public sealed class LoginRespFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Geek.Server.Proto.LoginResp>
    {
        // UserInfo
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Geek.Server.Proto.LoginResp value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
        ...
        public global::Geek.Server.Proto.LoginResp Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::Geek.Server.Proto.LoginResp();
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 8:
                        ...
                        continue;
                    case 7:
                        if (global::MessagePack.Internal.AutomataKeyGen.GetKey(ref stringKey) != 31356346278830402UL) { goto FAIL; }

                        ____result.BagInfo = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Geek.Server.Proto.UserBagInfo>(formatterResolver).Deserialize(ref reader, options);
                        continue;
                    case 9:
