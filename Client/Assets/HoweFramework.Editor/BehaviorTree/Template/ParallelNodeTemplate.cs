...
namespace HoweFramework.Editor
{
    ...
    public class ParallelNodeTemplate : BehaviorNodeTemplate_Composite
    {
        ...
        public override List<BehaviorNodePropertyTemplate> DefaultProperties =>
            ...
            {
                new BehaviorNodePropertyTemplate(1, "RequireAll", BehaviorNodePropertyValueType.Bool, "需要全部成功", false),
                new BehaviorNodePropertyTemplate(2, "RequireCount", BehaviorNodePropertyValueType.Int, "需要成功的数量", 1)
            };
    }
} 